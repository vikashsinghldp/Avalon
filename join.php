...
if(isset($_GET['join_user'])){
	...
	if($flag==1){
		...
		$new_day_bal = $income_data['day_bal']+2000;
		$new_current_bal = $income_data['current_bal']+2000;
		$new_total_bal = $income_data['total_bal']+2000;
					...
					if($temp_left_count>0 && $temp_right_count>0){
						if($temp_side=='left'){
							...
							if($temp_left_count<=$temp_right_count){
								...
								$new_current_bal = $income_data['current_bal']+1000;
